...
class UserRequest extends FormRequest
{
    ...
    protected function failedValidation(Validator $validator)
    {
        ...
        // Esse código é usado quando o servidor entende a requisição do cliente, mas não pode processá-la devido 
        // a erros de validação no lado do servidor.
    }
    ...
    /**
     * Retorna as mensagens de erro personalizadas paras as regras de validação.
     *
     * @return array
     */
