...
class UserController extends Controller
{
     ...
     * 
     * Este método recupera os detalhes de um usuário específico em formato JSON.
     *
     ...
     *
     * @param \Http\Requests\UserRequest $request O objeto de requisição contendo os dados do usuário a ser criado.
     * @return \Illuminate\Http\JsonResponse
     */
